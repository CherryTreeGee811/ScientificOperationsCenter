...
namespace ScientificOperationsCentre.Api.Tests.Mocks
{
    internal sealed class MockScientificOperationsCentreContext
    {
        public static ScientificOperationsCentreContext GetMock()
        {
            var options = new DbContextOptionsBuilder<ScientificOperationsCentreContext>()
            .UseInMemoryDatabase(databaseName: "TestDatabase")
            .Options;

            var mock = new ScientificOperationsCentreContext(options);
