...
using ScientificOperationsCentre.Api.Controllers;
...
namespace ScientificOperationsCentre.Api.Tests.SystemTests
{
    internal class TemperaturesSystemTest
    {
        private MockGroundControlUplinkDownlink _mockGroundControlUplinkDownlink;
        private ScientificOperationsCentreContext _scientificOperationsContext;
        ...
        public async Task SetUp()
        {
            ...
            _scientificOperationsContext = MockScientificOperationsCentreContext.GetMock();
