...
namespace ScientificOperationsCentre.Api.Mappers.Interfaces
{
    /// <summary>
    ...
    public interface IRadiationMeasurementsMapper
    {
        ...
        /// </remarks>
        Task<IEnumerable<RadiationMeasurementsViewModel>> GetRadiationMeasurementsForTheDayAsync(DateOnly date);
        ...
        /// </remarks>
        Task<IEnumerable<RadiationMeasurementsViewModel>> GetRadiationMeasurementsForTheMonthAsync(DateOnly date);
        ...
        /// </remarks>
        Task<IEnumerable<RadiationMeasurementsViewModel>> GetRadiationMeasurementsForTheYearAsync(DateOnly date);
    }
}
