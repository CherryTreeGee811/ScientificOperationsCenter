...
namespace ScientificOperationsCentre.Api.Mappers.Interfaces
{
    ...
    public interface ITemperaturesMapper
    {
        ...
        /// </remarks>
        Task<IEnumerable<TemperaturesViewModel>> GetTemperaturesForTheDayAsync(DateOnly date);
        ...
        /// </remarks>
        Task<IEnumerable<TemperaturesViewModel>> GetTemperaturesForTheMonthAsync(DateOnly date);
        ...
        /// </remarks>
        Task<IEnumerable<TemperaturesViewModel>> GetTemperaturesForTheYearAsync(DateOnly date);
    }
}
