...
using ScientificOperationsCentre.Api.CustomExceptions;
using ScientificOperationsCentre.Api.DAL.Interfaces;
using ScientificOperationsCentre.Api.Models;
using Serilog;


namespace ScientificOperationsCentre.Api.DAL
{
    /// <summary>
    /// Manages initial data access for temperatures.
    /// Filters data to meet the requirements of the ScientificOperationsCentre application.
    ...
    public sealed class TemperaturesRepository(
            ScientificOperationsCentreContext context
        ) : ITemperaturesRepository
    {
        ...
        private readonly ScientificOperationsCentreContext _context = context;
