...
builder.Services.AddDbContext<ScientificOperationsCentreContext>(options => 
    options.UseSqlServer(builder.Configuration.GetConnectionString("MSSQL")));

builder.Services.AddScientificOperationsCentreScopes();
builder.Services.AddControllers();
builder.Services.AddEndpointsApiExplorer();
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Scientific Operations Centre API", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Scientific Operations Centre API v1");
